...
class VolunteersControllerTest < ActionController::TestCase
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post :create, volunteer: {first_name: "Phillip", :last_name => "Robertson", :phone_number => "2566170926", :medical_id => SecureRandom.uuid, :insurance_carrier => "blue cross"}
    end
  ...
  test "should update volunteer" do
    patch :update, id: @volunteer, volunteer: {first_name: "Phillip", :last_name => "Robertson", :phone_number => "2566170926", :medical_id => SecureRandom.uuid, :insurance_carrier => "blue cross"}
    assert_redirected_to volunteer_path(assigns(:volunteer))
  end
